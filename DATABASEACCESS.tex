\frametitle{Pengertian Database} \par
...
\vspace{12pt}
\noindent 
\frametitle{Manfaat Penggunaan Database} \par
\noindent 
\begin{enumerate}
...
\noindent 
\frametitle{Apa yang dimaksud dengan}\textbf{ field, record, }\textbf{table, file, data  $  \&  $ basis data?} \par
...
\vspace{12pt}
\noindent 
\frametitle{Sifat-sifat database / basis data} \par
\noindent 
\begin{itemize}
...
\vspace{12pt}
\noindent 
\frametitle{Tipe Database / basis data} \par
\noindent 
...
\vspace{12pt}
\noindent 
\frametitle{Modul python}\textbf{ untuk mengakses database MySQL} \par
...
\vspace{12pt}
\noindent 
\frametitle{Python Database API} \par
...
\vspace{12pt}
\noindent 
\frametitle{Koneksi Database MySQL dengan Python} \par
\noindent 
\begin{enumerate}
